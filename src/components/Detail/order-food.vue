        ...
        <div class="foodslist">
          <app-scroll class="scroll">
            <li
              ...
              :key="food.id"
              v-show="food.category_id === selectedID"
            >
              <div class="food">
                ...
                <div class="foodDetail">
                  ...
                  <p>
                    <span class="month_sale">月售{{ food.month_sales }}份</span
                    ><span class="satisfy_rate"
                      >好评率{{ food.satisfy_rate }}%</span
                    >
                  </p>
                  <p>
                    <span class="discount_rate">{{ food.discount_rate }}折</span
                    ><span class="limit">每单限1份优惠</span>
                  </p>
                  <p>
